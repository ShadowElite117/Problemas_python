    ...
    while True:
        try:
            if n == 1:
                ...
                var = input("Introduzca el número que desea evaluar en la derivada del polinomio: ")
...
def main():
    ...
    resultado = evaluar_derivada(A_1, B, x)

    print("La derivada del polinomio (" + str(A) + ")x^2 + (" + str(B) + ")x + (" + str(C) + ") = (" + str(A_1) + ")x + (" + str(B) + ")")
    print("El resultado de f_1(" + str(x) + ") = (" + str(A_1) + ")x + (" + str(B) + ") = " + str(resultado))
